    ...
    <div className="fixed inset-0 bg-[#F0F2F5]/80 backdrop-blur-md z-[9999] flex flex-col items-center justify-center p-6 transition-all duration-300">
      <div className="flex flex-col items-center gap-6 max-w-sm w-full text-center">
        ...
        <div className="relative w-16 h-16 flex items-center justify-center">
          ...
          <div className="relative z-10 w-9 h-9 rounded-full bg-white flex items-center justify-center shadow-sm overflow-hidden p-1.5">
        ...
        <div className="flex flex-col gap-1.5">
          <h4 className="text-xs uppercase tracking-widest font-black text-red-500">{message}</h4>
